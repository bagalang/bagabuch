...
- дневник (от пост и ръчен); ДДС дневници от записите + редовете на фактурата
  (ставки 20 / 9 / 0, освободени, ВОД); ППДДС клетки 01-01…01-82;
  файлове за НАП (DEKLAR/POKUPKI/PRODAGBI в Windows-1251 + ZIP)
...
- потребители и роли (CRUD екрани); JWT скелетът още не проверява парола
  и не налага правата върху API
...
- проверка на права върху API (екраните `/users` `/roles` пишат таблиците)
- баланс / ОПР / ДМА справки / складови справки
- `company_id` върху фактури/продукти/дневник (мултитенантът е
  „активна фирма“ в settings; нови таблици — банки, дивиденти, рецепти,
  поръчки — вече имат `company_id`)
