...
`PLAN.md` в корена е пътната карта (прототип + какво следва). За „какво има
днес“ чети тук. При нова функция: обнови `status.md` + съответния файл в
таблицата.
