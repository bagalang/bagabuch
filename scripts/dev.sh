...
(cd "$BAGA_ROOT" && BOILA_PGPORT="$BOILA_PGPORT" ./baga -I . -I app-product app-product/boilaDB/tools/serve_pg.baga) &
pids+=($!)
...
(
  ...
  ./baga -I . -I app-product app-product/bagabuch/backend/start.baga
) &
pids+=($!)
